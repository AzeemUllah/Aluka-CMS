                    ...
                    <div class="row">
						...
						<div class="col-lg-3 col-md-6 col-sm-6" >
                            <div class="card card-stats"   >
                                ...
                                <div class="card-content">
                                    <p class="category"><?php echo substr($row['page_name'], 0, 7); ?></p>
                                    <h3 class="card-title"><?php echo(rand(10,100)); ?></h3>
                                </div>
                                <div class="card-footer">
                                    <div class="stats">
									
                                        <a href="dashboard-view-page-components.php?pageId=<?php echo $row["id"]?>&pageName=<?php echo $row["page_name"]?>"><i class="material-icons">local_offer</i> Tracked from Google Analytics</a>
                                    </div>
                                </div>
                            </div>
                        </div>
