...
<head>
    ...
    <!-- Canonical SEO -->
    <link rel="canonical" href="../../product/material-dashboard-pro_6.htm" />
    <!--  Social tags      -->
    ...
    -->
            ...
            <div class="sidebar-wrapper">
                ...
                <ul class="nav">
					...
					<li class="">
                        <a href="dashboard-create-pages.php">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a href="dashboard.html#">Shabih Haider responded to your email</a>
                                    </li>
                                    <li>
                                        <a href="dashboard.html#">You have 5 new tasks</a>
                                    </li>
                                    <li>
                                        <a href="dashboard.html#">You're now friend with Syed Rafay</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title">Page <?php echo $_GET['pageName']?> Customization</h4>
                                    <div class="row">
										...
										<?php 
											   ...
											   if($_SERVER["REQUEST_METHOD"] == "GET") {
												  ...
												  $pageId = mysqli_real_escape_string($db,$_GET['pageId']);
												  $pageName = mysqli_real_escape_string($db,$_GET['pageName']);
												  
												  $result = $obj->read_db_single_row("select * from ".$pageName, $conn);
												  while ($row = mysqli_fetch_assoc($result)) {
													  echo "<h3>".(string)$row['component_name']."</h3>";
																			foreach ($class_methods as $method_name) {
																				
																				if($row['component_name'] == $method_name)
											   ...
											   else echo "<h3>No page selected!</h3>"
											...
											<h3>Add, edit or remove components</h3>
											<div class="col-md-12">
                            <div class="card">
                                <div class="card-header card-header-icon" data-background-color="rose">
                                    <i class="material-icons">assignment</i>
                                </div>
                                <h4 class="card-title"><?php echo $_GET['pageName'] ?></h4>
                                <div class="card-content">
                                        ...
                                        <table class="table">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <?php
														$heading = array();
														$result = $obj->read_db_single_row("SHOW columns FROM ".$_GET['pageName'], $conn);
														while ($row = mysqli_fetch_assoc($result)) {
															echo "<th class='text-center'>".$row['Field']."</th>";
																array_push($heading,$row['Field']);
														}
													?>													
                                            ...
                                            <tbody>
                                                <tr>
													...
													<?php
														$result = $conn->query("select * FROM ".$_GET['pageName']);
														$heading_size = count($heading);
														$count = 0;
														if ($result->num_rows > 0) {
															...
															while($row = $result->fetch_assoc()) {
																...
																echo $heading[$count];
																echo "<td class='text-center'>".$row[$heading[$count]]."</td>";
																++$count;
																}
															$count = 0;
            ...
            <footer class="footer">
                <div class="container-fluid">
                    ...
                    <p class="copyright pull-right">
                        ...
                        <a href="">Azeem Ullah</a>, made with love for a better web
                    </p>
                </div>
            </footer>
        </div>
