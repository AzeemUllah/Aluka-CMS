...
<body>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title">Create a New Page... Customize on the Go!</h4>
                                    <div class="row">
                                ...
                                <div class="card-content">
                                    ...
                                    <form method="POST" action="/marocms/dashboard-create-pages.php">
                                        ...
                                        <div class="form-group label-floating">
                                            ...
                                            <input type="" class="form-control" id=pageType name=pageType>
                                        </div>
										
										
                                        <div class="checkbox">
                                            <label>
                                                <input type="checkbox" name="optionsCheckboxes"> Raised
                                            </label>
                                        </div>
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $pageType = mysqli_real_escape_string($db,$_POST['pageType']); 
      
      $sql = "CREATE TABLE ".$pageName." LIKE landing_page;";
	  $sql2  = "INSERT INTO `pages` (`id`, `page_name`, `page_type`, `raised`) VALUES (NULL, '".$pageName."', '".$pageType."', 'Y')";
